...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AjoutClient_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AjoutClient_t qt_meta_stringdata_AjoutClient = {
    {
QT_MOC_LITERAL(0, 0, 11), // "AjoutClient"
QT_MOC_LITERAL(1, 12, 20), // "on_b_valider_clicked"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 20) // "on_b_annuler_clicked"

    },
    "AjoutClient\0on_b_valider_clicked\0\0"
...
void AjoutClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AjoutClient *_t = static_cast<AjoutClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AjoutClient::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AjoutClient.data,
      qt_meta_data_AjoutClient,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AjoutClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AjoutClient.stringdata0))
        return static_cast<void*>(const_cast< AjoutClient*>(this));
